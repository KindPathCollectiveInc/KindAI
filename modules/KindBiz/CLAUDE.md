...
## What This Is
AI Workbench overlay for small business support and micro-enterprise — ai-workbench product overlay (FastAPI + server.py), port **7868**.
Runs offline-first. Data stays local.

## Operational Commands
- **Install**: `pip install -r requirements.txt`
- **Run**: `bash run.sh` (starts on port 7868)
